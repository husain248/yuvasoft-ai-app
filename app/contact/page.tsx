...
export const metadata: Metadata = {
  title: 'Contact Us — Yuvasoft AI',
  description: 'Get in touch with our team. We respond within one business day.',
}
          ...
          <div className="row gy-4 pt-120">
            <div className="col-lg-6 col-md-6 col-sm-12">
              ...
              <div className="d-flex align-items-start gap-5">
                <div className="contact-card-box flex-fill">
                  <div className="contact-card-text">
                    ...
                    <p className="contact-card-desc text_color_light_white">
                      715-7th Floor, Pukhraj Corporate, Navlakha Square,<br />
                ...
                <div className="contact-card-box flex-fill">
                  <div className="contact-card-text">
                    <h3 className="contact-card-title text_color_white">Canada Address</h3>
                    <p className="contact-card-desc text_color_light_white">
                      1469 Parkcrest Avenue,<br />
                      Kamloops BC V2B 4W5, CANADA.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="col-lg-6 col-md-6 col-sm-12">
              ...
              <div className="d-flex align-items-start flex-wrap">
                ...
                <div className="contact-card-box flex-fill">
                  <div className="contact-card-text">
                    <h3 className="contact-card-title text_color_white">Live Support</h3>
                    <p className="contact-card-desc text_color_light_white">
                      <a href="mailto:info@yuvasoftech.com">info@yuvasoftech.com</a><br />
                      <a href="mailto:hr@yuvasoftech.com">hr@yuvasoftech.com</a>
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <div className="section-title text-center">
                ...
                <p className="desc text_color_light_white">
                  Here&apos;s our simple, no-pressure process from first contact to project kick-off.
                </p>
              </div>
            </div>
          </div>
