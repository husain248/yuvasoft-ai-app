            ...
            <div className="footer-widget">
              <div className="footer-desc">
                ...
                <p className="text_color_light_white mt-3">
                  At Yuvasoft, we offer affordable and comprehensive range of
          ...
          <div className="col-lg-12">
            <div className="copy-right-wrap d-flex justify-content-between flex-column flex-lg-row">
              <p className="text_color_light_white">
                ...
                {' '}Copyright 2025 Yuvasoft.
              </p>
              <ul className="custom-ul social-list d-flex align-items-center flex-wrap">
                  <li>
                    <a href="#">
