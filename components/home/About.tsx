...
export default function About() {
  return (
    <section className="about-area bg_color_black pt-60">
      <div className="container">
        <div className="row">
          <div className="col-lg-12">
            <div className='d-flex w-full ai-about'>
              <div className="side-image">
                <img src="/assets/images/robot-ai.png" alt="Hero" />
              </div>
              <div className="about-wrap d-flex flex-fill flex-column flex-lg-column justify-content-between">
                  <div className="section-title text_white">
                    <span className="sub-title d-inline-block">Who We Are</span>
                    <h2 className="title"><span>About</span> Yuvasoft</h2>
                  </div>
                  <div className="about-info">
                    <p className="disc-2 text_white">
                    ...
                    <Link className="border-btn text_white" href="/about">
                      Learn More
                      <svg
                        className="icon"
                        width="24"
