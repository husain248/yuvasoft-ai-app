...
const products = [
  {
    ...
    title: 'Magicalswap',
    slug: 'magicalswap',
    description: 'A rental listing platform that connects property owners and tenants — owners list available homes, and tenants can search and rent properties that fit their needs.',
  },
  {
    image: '/assets/images/new-images-v2/resources/resources-2.png',
    title: 'Whereareyou',
    slug: 'whereareyou',
    description: 'Coming soon — currently in early development. Check back for updates as we build this one out.',
  },
  {
          ...
          <div className="col-lg-7">
            <div className="section-title">
              ...
              <p className="desc text_color_light_white">
                ...
                — live, in progress, and on the way.
              </p>
            </div>
          </div>
