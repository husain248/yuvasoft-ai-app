...
/* ── Categories ── */
const categories = ['All', 'Web App', 'Mobile App', 'UI/UX', 'AI Agents', 'E-Commerce']

/* ── Portfolio cards (no AI Agents cards — that tab has a custom layout) ── */
const portfolioItems = [
  {
    category: 'Web App',
    image: '/assets/images/new-images-v2/resources/resources-1.png',
    client: 'Magicalswap',
    clientAvatar: '/assets/images/yuva-logo-icon.png',
    tag: 'PropTech',
    title: 'Magicalswap — Rental Platform',
    time: '12 weeks',
  ...
  },
  {
    ...
    clientAvatar: '/assets/images/yuva-logo-icon.png',
    tag: 'Operations',
    title: 'Field Service Manager App',
    time: '10 weeks',
    href: '/contact',
  },
  {
...
/* ── Industries We Serve data (shown under AI Agents tab as cards) ── */
const aiAgentItems = [
  {
    image: '/assets/images/awesome-features/ai-feature-1.png',
    tag: 'Healthcare',
  ...
  return (
    <section id="portfolio-section" className="portfolio-area bg_color_black pt-0 pb-120">
      ...
      <div className="container">
        ...
        {/* ── All tabs: same card grid layout ── */}
        <>
          <div className="portfolio-grid">
            {(isAIAgents ? aiAgentItems : visible).map((item, i) => (
